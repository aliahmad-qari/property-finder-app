...
<Link to="/" className="flex items-center gap-3" onClick={closeMobileMenu}>
  <div className="h-9 w-9 bg-gradient-to-br from-primary to-orange-500 rounded-lg flex items-center justify-center shadow-lg shadow-primary/30">
    <span className="font-fraunces font-bold text-[#F9FAFB] text-xl leading-none">E</span>
  </div>
  <span className="font-fraunces text-2xl font-bold text-[#D4755B]">EstateFlow</span>
</Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          {isAuthenticated && user ? (
            <>
              ...
              <Link
                to="/add-property"
                className="bg-[#D4755B] text-[#F9FAFB] font-manrope font-bold px-5 py-2 rounded-lg hover:bg-[#B86851] transition-all hover:shadow-lg"
              >
                + List Property
              </Link>
              <button
...
<Link
                  to="/signup"
                  className="bg-primary text-[#F9FAFB] font-manrope font-bold px-6 py-2 rounded-lg hover:bg-[#1D6EE4] transition-all hover:shadow-lg"
                >
                  Sign Up
                </Link>
            </>
...
>
  <span className="font-material-icons text-2xl hover:rotate-90 transition-transform duration-300">
          ...
          <div className="border-t border-gray-100 my-2 pt-4 flex flex-col gap-4">
            {isAuthenticated && user ? (
              <>
                ...
                <Link
                  to="/add-property"
                  className="bg-[#D4755B] text-[#F9FAFB] font-manrope font-bold px-6 py-3 rounded-lg hover:bg-[#B86851] transition-all hover:shadow-lg text-center"
                  onClick={closeMobileMenu}
                >
                  + List Property
                </Link>
