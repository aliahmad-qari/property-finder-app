      ...
      <div className="max-w-[1280px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:pt-16">
            {/* Label */}
            <div className="mb-6">
              <p className="font-space-mono text-xs text-primary uppercase tracking-[2.4px]">
                Our Heritage
              </p>
            </div>
            ...
            {/* Headline */}
            <h2 className="mb-6">
              <span className="font-syne text-[40px] leading-[50px] text-[#111827] block font-semibold">
                Redefining the Real Estate Landscape with
              </span>
              <span className="font-fraunces italic text-[40px] leading-[50px] text-primary block">
            ...
            <div className="space-y-6 mb-8">
              <p className="font-manrope font-extralight text-base leading-[26px] text-[#4b5563]">
                Founded by architects and designers, BuildEstate emerged from a
              ...
              <p className="font-manrope font-extralight text-base leading-[26px] text-[#4b5563]">
                We set out to bridge the gap between data and warm living spaces. We don't just match square footage; we match
            ...
            <blockquote className="border-l-4 border-primary pl-6 mb-8">
              <p className="font-fraunces italic text-2xl leading-8 text-primary">
            ...
            <a 
              href="#team" 
              className="inline-flex items-center gap-2 border-b border-[#111827] pb-1 group hover:border-primary transition-colors"
            >
              <span className="font-space-mono text-sm text-[#111827] group-hover:text-primary transition-colors">
                Meet the Architects
              </span>

              <ArrowRight className="w-4 h-4 text-[#111827] group-hover:text-primary transition-colors" />
            </a>
          </div>
        </div>
      </div>
