...
const AboutHeroSection: React.FC = () => {
  return (
    <section className="relative bg-primary h-[480px] overflow-hidden">
      {/* Background Pattern */}
      <div 
...
<h1 className="font-fraunces text-[56px] leading-[61.6px] text-[#F9FAFB] mb-6">
  Redefining Real Estate with<br />
  <span className="italic text-[#D4755B]">Intelligence & Elegance</span>
</h1>
          
          {/* Divider */}
          <div className="w-24 h-px bg-[rgba(242,239,233,0.4)] mx-auto mb-8" />
          
          <p className="font-manrope font-extralight text-lg text-gray-300 tracking-wide">
