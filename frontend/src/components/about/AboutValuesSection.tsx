    ...
    <section className="bg-[#FAF8F4] py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="text-center mb-16">
          <div className="font-space-mono text-xs text-primary uppercase tracking-[1.2px] mb-4">
            Our Ethos
          </div>
          <h2 className="font-syne text-4xl text-[#111827]">
            Driven by Purpose
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-syne text-xl text-[#111827] mb-4">
                {value.title}
              </h3>
