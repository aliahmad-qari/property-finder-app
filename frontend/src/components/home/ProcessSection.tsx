        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-24">
              <div className="font-space-mono text-sm text-primary uppercase tracking-widest mb-6">Process</div>
...
<button className="bg-[#111827] text-[#F9FAFB] font-manrope font-medium px-8 py-3 rounded-lg shadow-lg hover:bg-[#1f2937] transition-all">
  Start Your Journey
</button>
            </div>
          </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="font-manrope text-base text-[#4b5563] leading-relaxed">
                    We learn your preferences, lifestyle needs, and financial goals to build a comprehensive
                    buyer profile.
                  </p>
                </div>
              </div>
