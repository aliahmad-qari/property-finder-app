        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 max-w-[500px] w-full">
            <form onSubmit={handleSubmit} className="flex gap-3">
              ...
              <button
                type="submit"
                className="bg-white hover:bg-[#F2EFE9] text-primary font-manrope font-bold text-base px-8 py-3.5 rounded-xl transition-all shadow-lg hover:shadow-xl whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
