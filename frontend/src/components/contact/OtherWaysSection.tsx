  ...
  const methods: ContactMethod[] = [
    {
      ...
      action: 'Start Chat',
      actionLink: 'https://wa.me/923079922301',
      bgColor: 'bg-[#E8F5E9]'
    },
    {
      icon: 'chat_bubble',
      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {methods.map((method, index) => (
            ...
            >
              {/* Icon */}
              <div className="w-16 h-16 bg-[#F9F7F2] rounded-2xl flex items-center justify-center mb-6">
              ...
              {/* Title */}
              <h3 className="font-syne font-bold text-xl text-[#111827] mb-3">
                {method.title}
              </h3>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 font-manrope font-bold text-sm text-primary hover:text-[#1D6EE4] transition-colors group"
              >
